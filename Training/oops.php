...
class Database{
    ...
    public static function Insert($conn,$firstname,$lastname,$email,$phno){  
       echo $firstname;
    ...
    public static function Empty($firstname, $lastname,$email,$phno){
    if($firstname == ""){
 ...
 {      
    public static function Editing($conn){     
...
if(isset($_POST['submit'])){
 ...
 $phno = $_POST['phno'];
   if($firstname == "" or $lastname =="" or $email == "" or $phno ==""){
    Database::Empty($firstname, $lastname,$email,$phno);
   }
   else{
     Database::Insert($conn,$firstname,$lastname,$email,$phno);
   }  
Edit::Editing($conn);
}
